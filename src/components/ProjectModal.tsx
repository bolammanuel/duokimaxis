      ...
      {project && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-950/70 backdrop-blur-md">
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl max-h-[85vh] overflow-y-auto bg-white rounded-[2.5rem] border border-slate-200 shadow-2xl p-6 sm:p-8 text-slate-900 z-10"
          ...
          >
            ...
            <div className="space-y-2 pr-12">
              ...
              <h2 className="font-heading font-extrabold text-2xl sm:text-3xl text-slate-900">{project.title}</h2>
            ...
            <div className="my-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-slate-950">
              <img src={project.image} alt={project.title} className="w-full max-h-[380px] object-cover object-top" />
            </div>
            ...
            <div className="space-y-5 my-6 text-xs sm:text-sm text-slate-600 leading-relaxed">
              <div className="p-4 rounded-xl bg-red-500/5 border border-red-500/10 space-y-1">
                <h4 className="font-heading font-bold text-slate-900 text-xs uppercase tracking-wider text-red-600">The Friction / Challenge</h4>
                <p>{project.challenge}</p>
              </div>

              <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/10 space-y-1">
                <h4 className="font-heading font-bold text-slate-900 text-xs uppercase tracking-wider text-emerald-600">The Solution Delivered</h4>
                <p>{project.solution}</p>
              </div>

              <div>
                <h4 className="font-heading font-bold text-slate-900 mb-2">Technologies & Architecture</h4>
