  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 py-4 pointer-events-none">
      <div className="max-w-6xl mx-auto flex items-center justify-between pointer-events-auto">
        ...
        <nav className="hidden md:flex items-center gap-1 px-4 py-1.5 rounded-full glass-nav-light">
          {navLinks.map((link) => {
      ...
      {/* Mobile Menu Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden mt-3 max-w-sm mx-auto rounded-2xl glass-nav-light p-4 shadow-xl pointer-events-auto">
