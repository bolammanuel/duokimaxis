...
export const Work: React.FC<WorkProps> = ({ onOpenPlanner }) => {
  ...
  return (
    <div className="pt-32 pb-20 space-y-16 max-w-5xl mx-auto px-4 sm:px-6">
      ...
      <StaggerParent staggerDelay={0.06} className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {PROJECTS_DATA.map((project) => (
          <StaggerChild key={project.id} className="h-full">
            <div
              ...
              className="glass-card-light rounded-3xl overflow-hidden cursor-pointer group flex flex-col justify-between h-full hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#FA4517]"
            >
              <div>
